...
let additions =
      ...
      , hello-world = ../01-hello-world/spago.dhall as Location
      , waves = ../02-waves/spago.dhall as Location
      , atari = ../03-atari/spago.dhall as Location
      , bwv846 = ../04-bwv846/spago.dhall as Location
      , e2020 = ../05-e2020/spago.dhall as Location
      , silent-night = ../06-silent-night/spago.dhall as Location
      , audio-behaviors =
        { dependencies =
          [ "aff-promise"
          , "painting"
